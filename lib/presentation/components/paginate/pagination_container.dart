...
import 'package:lnsp/presentation/components/paginate/button_arrow.dart';
import 'package:lnsp/presentation/components/paginate/paginate.dart';
import 'package:lnsp/presentation/components/paginate/skip_button.dart';
...
class Pagination extends StatefulWidget {
  ...
  final PaginateButtonArrowStyles paginateButtonStyles;
...
class _PaginationState extends State<Pagination> {
    ...
    setState(() {
      ...
      for (int j = 0; j < pages.length; j++) {
        ...
        if (counter == widget.show) {
          final int next = lastIndex + widget.show;
  ...
  Widget build(BuildContext context) {
    initialize();
    return !widget.useGroup ? nonGrouppedChild : groupedChild;
  }
          ...
          children: [
            ...
            Expanded(
              child: PageView.builder(
                ...
                itemCount:
                    groupedPages.where((element) => element.isNotEmpty).length,
                itemBuilder: (_, index) {
                  return Row(
                    children: groupedPages[index].map(
                      (e) {
                        return Expanded(
